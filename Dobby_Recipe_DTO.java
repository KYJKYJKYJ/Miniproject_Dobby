...
public class Dobby_Recipe_DTO {
	...
	public int getRecipe_chicken() {
		return recipe_chicken;
	}
	
	public void setRecipe_chicken(int recipe_chicken) {
		this.recipe_chicken = recipe_chicken;
	}
